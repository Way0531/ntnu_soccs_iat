define(['questAPI'], function(Quest){
	...
	[
		...
		},
		{
			...
			inherit : 'basicSelect',
			name : 'job_age',
			stem : '8. 請問您的服務年資為？（含全職實習）<br><span style="color:gray; font-size:0.8em;">例如：已完成全職實習而尚未考取諮商心理師執照者請填「1年」，已完成全職實習、考取諮商心理師並已執業1年者請填「2年」</span>',
			answers : [
		...
		},
		{
			...
			inherit : 'basicSelect',
			name : 'training',
			stem : '9. 你問您是否曾於碩士班在學或是執業期間，參與過同志議題相關之課程或專業訓練？',
			answers : [
			'是','否']
		},
		{
			...
			stem : '10. 請問您認為自身目前提供同志諮商之專業勝任能力為何？',
			answers : [
