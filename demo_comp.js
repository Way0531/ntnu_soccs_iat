define(['questAPI'], function(Quest) {
	...
	errorMsg: { required: "此題項為必填" }
		...
		inherit : 'basicSelectOld',
		name : 'job_age',
		stem : '9. 您執行諮商心理業務的服務年資為？（含全職實習）<br><span style="color:gray; font-size:0.8em;">請估算<b>實際進行諮商心理實務工作</b>的年資，例如：已完成全職實習而尚未考取諮商心理師執照者請選填「1年」，已完成全職實習、考取諮商心理師並已執業1年者請選填「2年」</span>',
		answers : [
    ...
    API.addQuestionsSet('competence', [
        ...
        {inherit: 'basicSelect', name: 'com_09', stem: '9. 我知道有一些研究指出同志個案比起異性戀個案更容易被診斷有精神疾患。'},
        {inherit: 'basicSelect', name: 'com_10', stem: '10. 很顯然，由兩個男性或兩個女性組成的同性關係，並不如由一男一女組成的關係那樣牢固或具承諾性。'},
        {inherit: 'basicSelect', name: 'com_11', stem: '11. 我認為同志案主應該朝向對自己的性傾向保持謹慎與低調的方向努力。'},
        {inherit: 'basicSelect', name: 'com_12', stem: '12. 我曾參與過同志議題（諮商、心理學、心理衛生）的在職訓練、研討會或工作坊。'},
        ...
        {inherit: 'basicSelect', name: 'com_20', stem: '20. 我知道諮商師經常將自身對於性的價值觀強加到同志個案身上。'},
        {inherit: 'basicSelect', name: 'com_21', stem: '21. 我認為我的個案應該接受在某種程度上遵從傳統的性價值觀。'},
        {inherit: 'basicSelect', name: 'com_22', stem: '22. 如果我的個案是同志，我目前並不具備足夠技巧或訓練去提供個案報告或諮詢。'},
        {inherit: 'basicSelect', name: 'com_23', stem: '23. 我認為同志個案會在與認同傳統價值觀與規範的異性戀諮商師的諮商工作中受益最多。'},
        {inherit: 'basicSelect', name: 'com_24', stem: '24. 在這個社會中，生為異性戀者具有一定的優勢。'},
        {inherit: 'basicSelect', name: 'com_25', stem: '25. 我覺得諮商師與個案之間性傾向的差異，可能會成為在與同志個案進行有效諮商初期的障礙。'},
        ...
        {inherit: 'basicSelect', name: 'com_29', stem: '29. 當談到同性戀時，我同意這樣的說法：「你應該要愛罪人，但憎恨或譴責那罪。」'}
    ]);
    ...
    API.addPagesSet('basicPage2', {
        header: '<span style="font-size:1.5em;">性傾向諮商勝任力量表</span></br></br>請根據您對於每個題項之描述的認同或符合程度進行填答，分數愈高代表認同或符合程度愈高。請務必填選最真實的分數，通常是您第一直覺反應。</br> *註：本量表中之「同志」所指的是<b>女同性戀者</b>、<b>男同性戀者</b>與<b>雙性戀者</b>（lesbian, gay and bisexual, LGB）。',
